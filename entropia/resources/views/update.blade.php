...
@section('content')
                  ...
                  <div class="form-group">
                      ...
                      <select name="producer" class="form-control">
                        @foreach($producer as $producers)
                         <option value="{{ $producers->id}}" @if($movie->producer_id == $producers->id) selected @endif>{{ $producers->name}}</option>
                        @endforeach
                      </select>
                  </div>
                </div>
        ...
        <div id="new_producer_modal" class="collapse">
            ...
            <div class="row">
                ...
                <button type="submit" id="producer_submit" class="btn btn-primary">Add Producer</button>
              </span>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                      ...
                      <select name="actors[]" multiple="multiple" class="form-control">    
                        ...
                        @if($actors->id == $castss->actor_id) selected="selected" @endif                         
                        @endforeach
                         >{{$actors->name}}</option>
                        @endforeach
                      </select>
        ...
        <div id="new_actors_modal" class="collapse">
            ...
            <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                <span class="pull-right">
                <button type="submit" id="actor_submit" class="btn btn-primary">Add Actor</button>
              </span>
                  </div>
                </div>
              </div><br>
